...
print('===============================================')
csvFile = input('What is your data file named (leave blank for default: Name&Number.csv)? ')
print('===============================================')
...
if len(str(csvFile)) == 0:
    print('You did not pick a data file.  Using the Name&Number.csv file as a data source.')
    print('===============================================')
    csvFile = 'Name&Number.csv'
...
if len(str(qrFolder)) == 0:
    print('You did not pick a folder name.  Using "savefolder" as the folder name.')
    print('===============================================')
    qrFolder = 'savefolder/'
else:
    qrFolder = qrFolder + '/'
